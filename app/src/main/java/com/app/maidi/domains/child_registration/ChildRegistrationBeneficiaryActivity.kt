...
class ChildRegistrationBeneficiaryActivity : BaseActivity<ChildRegistrationView, ChildRegistrationPresenter>(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_child_registration_beneficiary)
    ...
    fun setupTrackedEntityAttributeValues(){
        ...
        var gender = spGender.selectedItem as Option
        ...
        for(programEntityAttribute in programEntityAttributes){
            ...
            if(trackedEntityAttribute.displayName.contains("Gender")){
                createNewTrackedValue(trackedEntityAttributeValues, trackedEntityAttributeValue, programEntityAttribute, gender.code)
            }
