...
import com.app.maidi.domains.main.fragments.child_registration.ChildRegistrationChooseFragment
...
class MainFragment : BaseFragment() {
    ...
    fun onChildRegistrationModuleClicked(){
        if(MetaDataController.getProgramByName(Constants.BENEFICIARY_CHILD_REGISTRATION) != null
            ...
            mainActivity.transformFragment(
                ...
                ChildRegistrationChooseFragment()
            )
        }
    }
